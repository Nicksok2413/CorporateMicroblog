...
*   **Создание пользователей:** Регистрация пользователей не предусмотрена. Пользователей нужно добавить вручную в базу данных.
    *   **Способ 1 (psql в Docker):**
        ...
        \q
        ```
    *   **Способ 2 (Seed Script):** Создайте Python скрипт (например, `seed.py`) для добавления тестовых данных (пользователей, твитов, подписок). Запустите его после старта контейнеров (`python seed.py`). Пример скрипта можно найти в истории нашего диалога или создать по аналогии.
